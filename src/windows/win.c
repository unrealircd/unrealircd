	    ...
	    osvi.dwMajorVersion > 4)
	{
		...
		if (osvi.dwMajorVersion == 6 && osvi.dwMinorVersion == 1)
		{
			if (osvi.wProductType == VER_NT_WORKSTATION)
				...
				StringCchCat(pszOS, OSVER_SIZE, TEXT("Windows Server 2008 R2 "));
		}
		...
		if (osvi.dwMajorVersion == 6 && osvi.dwMinorVersion == 0)
		{
			if (osvi.wProductType == VER_NT_WORKSTATION)
				...
				StringCchCat(pszOS, OSVER_SIZE, TEXT("Windows Server 2008 "));
			...
			if (osvi.wProductType != VER_NT_WORKSTATION)
			{
				...
				else if (si.wProcessorArchitecture == PROCESSOR_ARCHITECTURE_AMD64)
				{
					if (osvi.wSuiteMask & VER_SUITE_DATACENTER)
						...
						StringCchCat(pszOS, OSVER_SIZE, TEXT("Standard x64 Edition"));
				}
		...
		if (osvi.dwMajorVersion == 5 && osvi.dwMinorVersion == 0)
		{
			...
			} else
			{
				if (osvi.wSuiteMask & VER_SUITE_DATACENTER)
					...
					StringCchCat(pszOS, OSVER_SIZE, TEXT("Server"));
			}
		}
