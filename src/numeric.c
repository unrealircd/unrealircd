...
/* 758 */ NULL,
/* 759 */ NULL,
/* 760 RPL_WHOISKEYVALUE */ "%s %s %s :%s",
/* 761 RPL_KEYVALUE */ "%s %s %s :%s",
/* 762 RPL_METADATAEND */ ":end of metadata",
/* 763 */ NULL,
/* 764 ERR_METADATALIMIT */ "%s :metadata limit reached",
/* 765 ERR_TARGETINVALID */ "%s :invalid metadata target",
/* 766 ERR_NOMATCHINGKEY */ "%s %s :no matching key",
/* 767 ERR_KEYINVALID */ ":%s",
/* 768 ERR_KEYNOTSET */ "%s %s :key not set",
/* 769 ERR_KEYNOPERMISSION */ "%s %s :permission denied",
/* 770 RPL_METADATASUBOK */ ":%s",
/* 771 RPL_METADATAUNSUBOK */ ":%s",
/* 772 RPL_METADATASUBS */ ":%s",
/* 773 ERR_METADATATOOMANYSUBS */ "%s",
/* 774 ERR_METADATASYNCLATER */ "%s %s",
/* 775 ERR_METADATARATELIMIT */ "%s %s %s :%s",
/* 776 ERR_METADATAINVALIDSUBCOMMAND */ "%s :invalid metadata subcommand",
/* 777 */ NULL,
/* 778 */ NULL,
/* 779 */ NULL,
/* 780 */ NULL,
