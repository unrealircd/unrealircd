...
extern MODVAR int (*webserver_handle_body_data)(Client *client, WebRequest *web, const char *readbuf, int length);
...
extern int webserver_handle_body_data_default_handler(Client *client, WebRequest *web, const char *readbuf, int length);
