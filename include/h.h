...
extern OperPermission ValidatePermissionsForPath(char *path, Client *sptr, Client *victim, Channel *channel, void *extra);
extern void OperClassValidatorDel(OperClassValidator *validator);

extern ConfigItem_ban  *Find_ban_ip(Client *sptr);
...
extern void iNAH_host(Client *sptr, char *host);
extern void set_snomask(Client *sptr, char *snomask);
extern char *get_sno_str(Client *sptr);
...
extern ConfigItem_deny_dcc *dcc_isforbidden(Client *sptr, char *filename);
extern ConfigItem_deny_dcc *dcc_isdiscouraged(Client *sptr, char *filename);
...
extern int umode_allow_all(Client *sptr, int what);
extern int umode_allow_unset(Client *sptr, int what);
...
extern int  channel_canjoin(Client *sptr, char *name);
extern char *collapse(char *pattern);
extern void dcc_sync(Client *sptr);
extern void report_flines(Client *sptr);
extern void report_network(Client *sptr);
extern void report_dynconf(Client *sptr);
...
extern u_long cres_mem(Client *sptr, char *nick);
...
extern int spamfilter_gettargets(char *s, Client *sptr);
...
extern void remove_oper_snomasks(Client *sptr);
extern void remove_oper_modes(Client *sptr);
...
extern int op_can_override(char* acl, Client *sptr,Channel *channel,void* extra);
extern Client *find_chasing(Client *sptr, char *user, int *chasing);
...
extern MODVAR void (*userhost_save_current)(Client *sptr);
extern MODVAR void (*userhost_changed)(Client *sptr);
extern MODVAR void (*send_join_to_local_users)(Client *sptr, Channel *chptr, MessageTag *mtags);
...
extern char *getcloak(Client *sptr);
...
extern void remove_oper_privileges(Client *sptr, int broadcast_mode_change);
...
extern void parse_chanmodes_protoctl(Client *sptr, char *str);
...
extern int is_handshake_finished(Client *sptr);
