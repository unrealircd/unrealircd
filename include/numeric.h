...
#define STR_RPL_YOURID			/* 042 */	"%s :your unique ID"
...
#define STR_RPL_TRACEOPERATOR		/* 204 */	"Operator %s %s [%s] %ld"
#define STR_RPL_TRACEUSER		/* 205 */	"User %s %s [%s] %ld"
#define STR_RPL_TRACESERVER		/* 206 */	"Server %s %dS %dC %s %s!%s@%s %ld"
#define STR_RPL_TRACESERVICE		/* 207 */	"Service %s %s"
...
#define STR_RPL_STATSOLDNLINE		/* 214 */	"%c %s * %s %d %d %s"
#define STR_RPL_STATSILINE		/* 215 */	"I %s %s %d %d %s %s %d"
#define STR_RPL_STATSKLINE		/* 216 */	"%s %s %s"
#define STR_RPL_STATSQLINE		/* 217 */	"%c %s %ld %ld %s :%s"
#define STR_RPL_STATSYLINE		/* 218 */	"Y %s %d %d %d %d %d"
#define STR_RPL_ENDOFSTATS		/* 219 */	"%c :End of /STATS report"
#define STR_RPL_STATSBLINE		/* 220 */	"%c %s %s %s %d %d"
#define STR_RPL_UMODEIS			/* 221 */	"%s"
#define STR_RPL_SQLINE_NICK		/* 222 */	"%s :%s"
#define STR_RPL_STATSGLINE		/* 223 */	"%c %s %li %li %s :%s"
#define STR_RPL_STATSTLINE		/* 224 */	"T %s %s %s"
#define STR_RPL_STATSELINE		/* 225 */	/* 225    STR_RPL_STATSELINE (we use 230 instead) */ NULL
#define STR_RPL_STATSNLINE		/* 226 */	"n %s %s"
#define STR_RPL_STATSVLINE		/* 227 */	"v %s %s %s"
#define STR_RPL_STATSBANVER		/* 228 */	"%s %s"
#define STR_RPL_STATSSPAMF		/* 229 */	"%c %s %s %s %li %li %li %s %s :%s"
#define STR_RPL_STATSEXCEPTTKL		/* 230 */	"%s %s %li %li %s :%s"
#define STR_RPL_RULES			/* 232 */	":- %s"
#define STR_RPL_STATSLLINE		/* 241 */	"%c %s * %s %d %d"
#define STR_RPL_STATSUPTIME		/* 242 */	":Server Up %ld days, %ld:%02ld:%02ld"
#define STR_RPL_STATSOLINE		/* 243 */	"%c %s * %s %s %s"
#define STR_RPL_STATSHLINE		/* 244 */	"%c %s * %s %d %d"
#define STR_RPL_STATSSLINE		/* 245 */	"%c %s * %s %d %d"
...
#define STR_RPL_HELPFWD			/* 294 */	":Your help-request has been forwarded to Help Operators"
#define STR_RPL_HELPIGN			/* 295 */	":Your address has been ignored from forwarding"
...
#define STR_RPL_WHOISHELPOP		/* 310 */	"%s :is available for help."
...
#define STR_RPL_WHOISIDLE		/* 317 */	"%s %ld %ld :seconds idle, signon time"
...
#define STR_RPL_CREATIONTIME		/* 329 */	"%s %lu"
...
#define STR_RPL_TOPICWHOTIME		/* 333 */	"%s %s %lu"
...
#define STR_RPL_SUMMONING		/* 342 */	"%s :User summoned to irc"
#define STR_RPL_WHOISCOUNTRY		/* 344 */	"%s %s :is connecting from %s"
#define STR_RPL_INVEXLIST		/* 346 */	"%s %s %s %lu"
#define STR_RPL_ENDOFINVEXLIST		/* 347 */	"%s :End of Channel Invite List"
#define STR_RPL_EXLIST			/* 348 */	"%s %s %s %lu"
...
#define STR_RPL_BANLIST			/* 367 */	"%s %s %s %lu"
...
#define STR_RPL_INFOSTART		/* 373 */	":Server INFO"
...
#define STR_RPL_MYPORTIS		/* 384 */	"%d :Port to local server is\r\n"
...
#define STR_ERR_NOTOPLEVEL		/* 413 */	"%s :No toplevel domain specified"
#define STR_ERR_WILDTOPLEVEL		/* 414 */	"%s :Wildcard in toplevel Domain"
...
#define STR_ERR_FILEERROR		/* 424 */	":File error doing %s on %s"
...
#define STR_ERR_NICKCOLLISION		/* 436 */	"%s :Nickname collision KILL"
...
#define STR_ERR_TARGETTOOFAST		/* 439 */	"%s :Message target change too fast. Please wait %ld seconds"
...
#define STR_ERR_NOLOGIN			/* 444 */	"%s :User not logged in"
#define STR_ERR_SUMMONDISABLED		/* 445 */	":SUMMON has been disabled"
#define STR_ERR_USERSDISABLED		/* 446 */	":USERS has been disabled"
...
#define STR_ERR_HOSTILENAME		/* 455 */	":Your username %s contained the invalid character(s) %s and has been changed to %s. Please use only the characters 0-9 a-z A-Z _ - or . in your username. Your username is the part before the @ in your email address."
#define STR_ERR_NOHIDING		/* 459 */	"%s :Cannot join channel (+H)"
...
#define STR_ERR_NOPERMFORHOST		/* 463 */	":Your host isn't among the privileged"
#define STR_ERR_PASSWDMISMATCH		/* 464 */	":Password Incorrect"
#define STR_ERR_YOUREBANNEDCREEP	/* 465 */	":%s"
#define STR_ERR_KEYSET			/* 467 */	"%s :Channel key already set"
#define STR_ERR_ONLYSERVERSCANCHANGE	/* 468 */	"%s :Only servers can change that mode"
#define STR_ERR_LINKSET			/* 469 */	"%s :Channel link already set"
...
#define STR_ERR_BADCHANMASK		/* 476 */	"%s :Bad Channel Mask"
...
#define STR_ERR_LINKFAIL		/* 479 */	"%s :Sorry, the channel has an invalid channel link set."
...
#define STR_ERR_CANTKILLSERVER		/* 483 */	":You cant kill a server!"
#define STR_ERR_ATTACKDENY		/* 484 */	"%s :Cannot kick protected user %s."
#define STR_ERR_KILLDENY		/* 485 */	":Cannot kill protected user %s."
#define STR_ERR_NONONREG		/* 486 */	":You must identify to a registered nick to private message %s"
...
#define STR_ERR_NOSWEAR			/* 490 */	":%s does not accept private messages containing swearing."
#define STR_ERR_NOOPERHOST		/* 491 */	":No O-lines for your host"
#define STR_ERR_NOCTCP			/* 492 */	":%s does not accept CTCPs"
...
#define STR_ERR_NEEDPONG		/* 513 */	":To connect, type /QUOTE PONG %lX"
...
#define STR_ERR_ADMONLY			/* 519 */	":Cannot join channel %s (Admin only)"
...
#define STR_ERR_WHOSYNTAX		/* 522 */	":/WHO Syntax incorrect, use /who ? for help"
...
#define STR_RPL_NOWON			/* 604 */	"%s %s %s %ld :is online"
#define STR_RPL_NOWOFF			/* 605 */	"%s %s %s %ld :is offline"
#define STR_RPL_WATCHLIST		/* 606 */	":%s"
#define STR_RPL_ENDOFWATCHLIST		/* 607 */	":End of WATCH %c"
#define STR_RPL_CLEARWATCH		/* 608 */	":Your WATCH list is now empty"
#define STR_RPL_NOWISAWAY		/* 609 */	"%s %s %s %ld :is away"
...
#define STR_ERR_NICKLOCKED		/* 902 */	":You must use a nick assigned to you."
...
#define STR_ERR_SASLALREADY		/* 907 */	":You have already completed SASL authentication"
...
#define STR_ERR_NUMERICERR		/* 999 */	"Numeric error!"
