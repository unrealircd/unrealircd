...
USE_REMOTEINC=1 ^
LIBCURL_INC_DIR="c:\projects\unrealircd-5-libs\curl-ssl\include" ^
LIBCURL_LIB_DIR="c:\projects\unrealircd-5-libs\curl-ssl\builds\libcurl-vc-x64-release-dll-ssl-dll-cares-dll-ipv6-obj-lib" ^
